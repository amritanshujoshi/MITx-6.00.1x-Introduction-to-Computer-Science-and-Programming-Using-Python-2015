...
WORDLIST_FILENAME = "D:\Edx\Introduction to Computer Science and Programming using Python\Lab Codes\Week 4\ProblemSet4\words.txt"
...
def updateHand(hand, word):
    ...
    for letter in word:
        if letter in hand and hand.get(letter, 0) > 0:
...
def isValidWord(word, hand, wordList):
    ...
    for letter in word:
        if letter not in handCopy or handCopy.get(letter, 0) == 0:
            return False
        else:
            handCopy[letter] -= 1
